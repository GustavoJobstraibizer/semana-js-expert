class VideoMediaPlayer {
  ...
  initializeCodec() {
    ...
    if (!mediaSourceSupported) {
      alert("Seu browser ou sistema nao tem suporte para MSE!");
      return;
    }
    ...
    if (!codecSupported) {
      alert(
        `Seu browser ou sistema nao suporta o codec ${this.manifestJSON.codec}`
      );
      return;
    }
  ...
  async nextChunk(data) {
    ...
    // deixar o restante do video rodar enquanto baixa o novo video
